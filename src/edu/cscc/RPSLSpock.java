...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick - user's choice between rock, paper, scissors, lizard, and spock; checks if pick is valid with isValidPick
     * @return user's selection (without case-sensitivity)
     */
    ...
    /**
     *
     * @return returns a string for the "opponent's pick" based on a 5 integer switch case.
     */
